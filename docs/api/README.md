...
Propora-API is the backend for [Propora](../../Propora-Frontend): a multi-tenant REST API
...
[README.md](../../Propora-Backend/README.md) for environment variables and setup.
